...
export default function App({ navigator }) {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('https://671cccf009103098807b3be8.mockapi.io/api/v1/category');
  ...
  const fetchLocations = async () => {
    try {
      const response = await fetch('https://671cccf009103098807b3be8.mockapi.io/api/v1/location');
